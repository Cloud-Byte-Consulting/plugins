...
description: >-
  Test whether maintainers understand critical code. Use before merging AI-generated changes
  or changes that affect shared resources, credentials, or critical paths.
---
...
## Context
## Prompt 3: Comprehension Gate
**Job:** Review a diff or PR the way a careful senior engineer would — not for syntax or test coverage, but for system-level comprehension: blast radius, cross-service side effects, credential exposure, missing TTLs, and emergent behavior risks.
**When to use:** Before merging any AI-generated PR. Before merging human-written PRs that touch critical paths, shared resources, or authentication/authorization.
...
Source: [Prompt 3: Comprehension Gate](https://app.notion.com/p/26443fec9b62456eaa3a8b46fa9e4ec5)
